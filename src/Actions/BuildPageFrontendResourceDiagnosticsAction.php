...
class BuildPageFrontendResourceDiagnosticsAction
{
    ...
    public function handle(Page $page): array
    {
        ...
        return [
            ...
            'graph' => BuildFrontendResourceGraphAction::run($renderData->assetManifest, $context),
            'conflicts' => DetectFrontendResourceConflictsAction::run($renderData->assetManifest),
            'report' => $report,
            'budget' => $budget,
